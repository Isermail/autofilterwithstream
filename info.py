...
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/697d1e8ad6a7268273c13.jpg")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001960613454 -1001554775086').split()]
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/openlink_movierequest/5")
VERIFY2_URL = environ.get('VERIFY2_URL', "onepagelink.in")
VERIFY2_API = environ.get('VERIFY2_API', "08103765e9c6b05d85b37dd0bacdafd544f603ee")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Kanhaiya_me')
...
URL = "https://kanhaiya-unknown24680.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kanhaiya-unknown24680.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://kanhaiya-unknown24680.koyeb.app/".format(FQDN)
else:
    URL = "https://kanhaiya-unknown24680.koyeb.app/".format(FQDN)
